...
def get_search_entries(search_term, search_arguments):
    try:
        ...
        buynow = search_arguments.get('buynow') if search_arguments.get('buynow') != None else "false"
        shipping = search_arguments.get('shipping') if search_arguments.get('shipping') != None else ""
